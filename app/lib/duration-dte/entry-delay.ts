...
export interface EntryDelayScenarioSummary {readonly supportN:number;readonly denominatorN:number;readonly economicN:number;readonly medianActualDelayHours:number|null;readonly medianRemainingDte:number|null;readonly medianCreditChangeVsReferenceNative:number|null;readonly medianCreditChangeVsReferenceUsd:number|null;readonly medianOutcomePnl:number|null;readonly preEntryResolutionCount:number;}
