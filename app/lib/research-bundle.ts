...
export const RESEARCH_BUNDLE_SCHEMA_VERSION="4.3.0" as const;
/** Bundle schema versions this app can still import (see importResearchBundle). */
export const LEGACY_RESEARCH_BUNDLE_SCHEMA_VERSIONS=["1.0.0","2.0.0","2.1.0","2.2.0","2.3.0","3.0.0","3.1.0","3.2.0","3.3.0","3.4.0","3.5.0","3.6.0","3.7.0","3.8.0","3.9.0","4.0.0","4.1.0","4.2.0"] as const;
...
export function validateResearchBundle(files:Partial<Record<string,string>>):{ok:boolean;errors:string[]}{
 ...
 const currentCompatibleMigration=migratedFrom==="3.8.0"||migratedFrom==="3.9.0"||migratedFrom==="4.0.0";
