...
export function compactResearchSelectionEvent(event:ResearchSelectionEvent):ResearchSelectionEvent{
 ...
 const compactStructure=<T extends SelectedStructure>(structure:T):T=>{
  ...
  const compacted={...structure,...(referenceValuation===undefined?{}:{referenceValuation}),...(delayedExecution===undefined?{}:{delayedExecution}),...(modeledExecution===undefined?{}:{modeledExecution}),...(!evidenceUsages.length&&structure.evidenceUsages===undefined?{}:{evidenceUsages})} as T;
